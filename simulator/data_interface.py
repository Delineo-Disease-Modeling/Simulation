...
BASE_URL = "https://covidweb.isi.jhu.edu/api/db"


def stream_data(url = "https://covidweb.isi.jhu.edu/api/db/patterns/1?stream=true"):
...
def load_movement_pap_data(cz_id=1): 
    url = "https://covidweb.isi.jhu.edu/api/db/patterns/2"
...
def load_movement_pap_data_streaming(url: str = 'https://covidweb.isi.jhu.edu/api/db/patterns/1?stream=true') -> Generator[Dict[str, Any], None, None]:
    """
...
if __name__ == "__main__":
    for data_chunk in StreamDataLoader.stream_data("https://covidweb.isi.jhu.edu/api/db/patterns/1?stream=true"):
